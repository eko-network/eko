  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(children: [
      Row(
        children: [
          LikeButton(
            isLiked: comment.likeState ==
                LikeState.liked, //user.likedPosts.contains(comment.id),
            likeBuilder: (isLiked) {
              return icons.Like(
                size: c.postIconSize,
            ...
            onTap: (isLiked) async {
              ref.read(commentProvider(comment.id).notifier).likeToggle();
              return !isLiked;
            },
      ...
      Row(
        children: [
          LikeButton(
            isLiked: comment.likeState ==
                LikeState
                    .disliked, //user.dislikedPosts.contains(comment.id), //dislike
            ...
            onTap: (isDisliked) async {
              ref.read(commentProvider(comment.id).notifier).dislikeToggle();
              return !isDisliked;
            },
            likeCountAnimationType: LikeCountAnimationType.none,
            likeCountPadding: null,
